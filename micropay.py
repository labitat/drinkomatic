...
# condition for card hash and related variables below
card_cond = threading.Condition()
...
# condition for barcode and related variables below
barcode_cond = threading.Condition()
